...
class SmsController(private val context: Context) {
    ...
    // SEND SMS
    fun sendSms(destinationAddress: String, messageBody: String,simSlot: String, listenStatus: Boolean) {
    ...
    fun sendMultipartSms(destinationAddress: String, messageBody: String,simSlot: String, listenStatus: Boolean) {
        val smsManager = getSmsManager(simSlot)
